...
var style_IndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.204233 && value <= 0.297853) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.297853 && value <= 0.391473) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.391473 && value <= 0.485093) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.485093 && value <= 0.578713) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.578713 && value <= 0.672333) {
            style = [ new ol.style.Style({
