...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.102949 && value <= -0.037594) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.037594 && value <= 0.027760) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.027760 && value <= 0.093115) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.093115 && value <= 0.158469) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.158469 && value <= 0.223824) {
            style = [ new ol.style.Style({
